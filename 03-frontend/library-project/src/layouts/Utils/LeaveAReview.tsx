...
export const LeaveAReview: React.FC<{}> = (props) => {
    ...
    const [reviewDescription , setReviewDesciption] = useState('');
            ...
            {displayInput && 
                <form method='POST' action='#'>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className='form-control' id="submitReviewDescription" placeholder='Optional' rows={3} onChange={e => setReviewDesciption(e.target.value)}></textarea>
                    </div>

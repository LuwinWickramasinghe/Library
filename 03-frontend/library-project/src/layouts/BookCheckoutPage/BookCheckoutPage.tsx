...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviews = async() => {
            ...
            if(!responseReviews){
                throw new Error('Something Went Wrong when fetching Reviews!');
        ...
        const fetchUserCurrentLoansCount = async () => {
            if(authState && authState.isAuthenticated) {
                ...
                if (!currentLoansCountResponse.ok){
                    throw new Error('Somthing went wrong in currentloanscount');
                }
        ...
        const fetchUserCheckedOutBook = async () => {
            if (authState && authState.isAuthenticated) {
                ...
                if(!bookCheckedOut.ok) {
                    throw new Error('somthing went wrong in cookcheckedout');
    ...
    async function checkoutBook() {
        ...
        if(!checkoutResponse.ok){
            throw new Error('Something went wrong in checkoutbook function')
        }

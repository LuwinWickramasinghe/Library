...
export const ManageLibraryPage = () => {
    ...
    function clickChangeBookQuantity(){
        ...
        <div className='mt-5'>
            ...
            <nav>
                <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                    <button onClick={addBookClick} className='nav-link active' id='nav-add-book-tab' data-bs-toggle='tab' 
                    ...
                    <button onClick={clickMessages} className='nav-link' id='nav-messages-tab' data-bs-toggle='tab' 

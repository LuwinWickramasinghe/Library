...
export const MessagesPage= () => {
    ...
    const [isMessagesClick, setIsMessagesClick] = useState(false);
            ...
            <div className='mt-3 mb-2'>
                <nav>
                    <div className='nav nav-tabs' id='nav-tab' role='tablist'>
                        <button onClick={() => setIsMessagesClick(false)} className='nav-link active' 
                        ...
                        <button onClick={() => setIsMessagesClick(true)} className='nav-link' 
